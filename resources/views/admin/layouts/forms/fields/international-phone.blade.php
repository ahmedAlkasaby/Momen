...
'data-parsley-type' => $text_type ?? 'number',
'data-parsley-pattern' => $pattern ?? '^00[0-999][0-9]{9,12}',
];

if (!isset($not_req)) {
$array_control['required'] = true; // boolean مش string
}
...
{!!
html()
->text($field_name, $text_value ?? null)

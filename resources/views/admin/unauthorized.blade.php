...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-1 mt-4">{{__('site.not_authorized')}}</h2>
            <a href="{{ route('dashboard.home.index') }}" class="btn btn-primary mb-4">{{__('site.back_home')}}</a>
            <div class="mt-4">
                <img src="{{asset("admin/assets/img/illustrations/page-misc-error.png")}}" alt="page-misc-error"

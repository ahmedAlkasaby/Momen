...
@section('title', __('site.orderItemReturns'))
@section('styles')
...
@section('content')
    ...
    <div class="card">
        @include('admin.orderItemReturns.includes.table')
    </div>
    </div>
    @include('admin.orderItemReturns.includes.filter')
...
@section('jsFiles')
    ...
    @include('admin.layouts.table.ajaxCancel', ['model' => 'orderItemReturns'])
